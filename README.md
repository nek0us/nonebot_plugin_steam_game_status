...
| steam结束图片黑白开启/steam结束图片黑白关闭 | 否 | 群聊 | 群员 |       设置结束游戏图片播报是否将用户头像显示为黑白，默认关闭        |
| steam结束背景黑白开启/steam结束背景黑白关闭 | 否 | 群聊 | 群员 |       仅在结束图片黑白开启后生效，设置结束游戏卡片背景图是否显示为黑白，默认关闭        |
...
4. 新增状态卡片游戏背景图群开关，开始/切换卡片默认开启，结束卡片默认关闭；结束卡片可在头像黑白时额外开启背景黑白
